...
class Product
{
    ...
    public static function getLatestProducts($count = self::SHOW_BY_DEFAULT)
    {
        ...
        // Текст запроса к БД
        $sql = 'SELECT id, name, price, is_new FROM action '
    ...
    public static function getTotalProductsInCategory($categoryId)
    {
        ...
        // Текст запроса к БД
        $sql = 'SELECT count(category_id) AS count FROM action WHERE status="1" AND category_id = :category_id';
    ...
    public static function getProdustsByIds($idsArray)
    {
        ...
        // Текст запроса к БД
        $sql = "SELECT * FROM action WHERE status='1' AND id IN ($idsString)";
    ...
    public static function getProductsList()
    {
        ...
        // Получение и возврат результатов
        $result = $db->query('SELECT id, name, price, code FROM action ORDER BY id ASC');
        $productsList = array();
        $i = 0;
        while ($row = $result->fetch()) {
            $productsList[$i]['id'] = $row['id'];
    ...
    public static function createProduct($options)
    {
        ...
        // Текст запроса к БД
        $sql = 'INSERT INTO `action`(name, code, price, category_id, brand, availability,description, is_new,  status)'
                . 'VALUES '
